...
const config = {
  ...
  tagline: 'Learn ROS 2 concepts for humanoid robotics development',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} ROS 2 Humanoid Education. Built with Docusaurus.`,
      },
      prism: {
